...
angular.module('myApp.services', [])
    ...
    return {
        ...
        getRegisters: function(objeto, rpp, filter, filteroperator, filtervalue, systemfilter, systemfilteroperator, systemfiltervalue) {
            var filterParams = getFilter(filter, filteroperator, filtervalue);
            var systemfilterParams = getFilter(systemfilter, systemfilteroperator, systemfiltervalue);
            return $http.get('/' + appName + '/' + objeto + '/getregisters.json?' + filterParams + systemfilterParams).then(function(result) {
                return result.data;
            });
        },
