...
<div class="container">
    <div class="row-fluid">
        <div class="span12 hero-unit">
            ...
            <span ng-bind-html="numOfertas"></span><span> <strong>PUESTOS VACANTES</strong> de {{empresas.length}} <strong>empresas</strong></span>
        </div>
        <div class="span12">
        </div>
    </div>
    <div class="row-fluid">
        ...
        <div class="span7">
            <div class="row" ng-repeat="ofe in ofertas">
                ...
                <div class="row">
                    ...
                    <div class="span3">{{ofe.fechaini}}</div>
                    <div class="span3">
                        <div class="btn-group">
