            ...
            <tr ng-repeat="pro in productos">
                ...
                <td>
                    <div class="btn-toolbar">
                        <div class="btn-group">
                            <a class="btn btn-mini action02" href="#/producto/view/{{pro.id}}"><i class="icon-zoom-in"></i></a>
                            <a class="btn btn-mini action03" href="#/producto/edit/{{pro.id}}"><i class="icon-pencil"></i></a>
                            <a class="btn btn-mini action04" href="#/producto/delete/{{pro.id}}"><i class="icon-remove"></i></a>
                        </div> 
                    </div>
