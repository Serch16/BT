...
<div class="row-fluid">
    <div class="span7">       
        ...
        <div id="order"></div>
        <div id="filter"></div>  
        <div id="registers">Mostrando {{objetos.length}} registros ({{nrpp}} por página)</div>
            ...
            <tr ng-repeat="obj in objetos">
                ...
                <td>
                    <div class="btn-toolbar">
                        <div class="btn-group">
                            <a class="btn btn-mini action02" href="#/tipoproducto/view/{{obj.id}}"><i class="icon-zoom-in"></i></a>
                            <a class="btn btn-mini action03" href="#/tipoproducto/edit/{{obj.id}}"><i class="icon-pencil"></i></a>
                            <a class="btn btn-mini action04" href="#/tipoproducto/delete/{{obj.id}}"><i class="icon-remove"></i></a>
                        </div> 
                    </div>
